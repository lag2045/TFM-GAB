...
# Parámetros de la caja simulada
...
plt.ylabel(r'$\xi(r)$')
plt.title('Función de correlación de galaxias')
plt.legend()
plt.grid()
plt.savefig("/Users/hakeem/Desktop/Funcion_correlacion_galaxias.png", dpi=300, bbox_inches='tight')
plt.show()
